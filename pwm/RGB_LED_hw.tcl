...
add_interface_port export blue_pwm blue_pwm Output 1
add_interface_port export red_pwm red_pwm Output 1
add_interface_port export green_pwm green_pwm Output 1
